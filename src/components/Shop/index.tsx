  ...
  return (
    <>
      ...
      <Row>
        ...
        {products.map((CardProductItem, i) => {

            return (

              <Col key={i}>
                <Card>
                  <Card.Img variant="top" src={CardProductItem.image} />
                  <Card.Body>
                    <Card.Title>{CardProductItem.name}</Card.Title>
                    <Card.Text>
                      {CardProductItem.desc}

                      <Quantity price={CardProductItem.price} />
                    </Card.Text>

                    <ButtonContainer variant={"default"} onClick={e => console.log(e.target)}>
